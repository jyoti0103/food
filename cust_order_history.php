...
<body class="d-flex flex-column h-100">
                                ...
                                <a href="cust_order_detail.php?orh_id=<?php echo $og_row["orh_id"] ?>"
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        WHERE orh_id = {$og_row['orh_id']}";
                                                ...
                                                <div class="col mt-1 mb-2"><strong class="h5">Rs.
                                                        <?php echo $ord_arr["gt"] ?></strong></div>
    ...
    <footer
        ...
        <span class="smaller-font">&copy; The Four Snippets <br /><span class="xsmall-font">lumbini cafeteria
                </span></span>
