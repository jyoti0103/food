    ...
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            ...
            <div class="col text-wrap">
                ...
                <h3 class="fw-light">Rs. <?php echo $food_row["f_price"] ?></h3>
                ...
                <div class="form-amount">
                    <form class="mt-3" method="POST" action="add_item.php">
                        ...
                        <button class="btn btn-success w-100" type="submit" title="add to cart" name="addtocart" <?php
                        ...
                        if ($cartsearch_row1["cnt"] > 0) {
                            ...
                            if ($cartsearch_row2["cnt"] == 0) { ?> onclick="javascript: return changeshopcf();" <?php
                            }
                        }
                        ?>>
