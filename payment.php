...
<body class="d-flex flex-column">
    <header class="navbar navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/Logo.png" width="80" class="me-2" alt="Lumbini Logo">
            </a>
        </div>
    </header>
    <div class="container px-5 py-4" id="shop-body">
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            <div class="col mb-3 qr mb-md-0">
                <img src="img/myqr.jpg" class="img-fluid rounded-25 float-start" alt="qr">
            ...
            <form method="POST" action="add_order.php" class="form-floating">
                ...
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="tid" placeholder="transactionid" name="tid"
                        minlength="12" maxlength="45" required>
