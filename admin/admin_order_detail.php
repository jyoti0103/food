...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 border-bottom">
            ...
            <div class="row mb-3">
                <div class="col">
                    <a class="btn btn-sm btn-primary mt-2 mt-md-0"
                        href="admin_order_update.php?orh_id=<?php echo $_GET["orh_id"] ?>">
                                    ...
                                    <a class="text-decoration-none"
                                        ...
                                        <li
                                            ...
                                            <div class="ms-3 me-auto">
                                                <div class="fw-normal"><span
                                                        class="h5"><?php echo $ord_row["ord_amount"] ?>x
                                                    </span><?php echo $ord_row["f_name"] ?>
                                                    <p><?php printf("Rs. %.2f <small class='text-muted'>(Rs. %.2f each)</small>", $ord_row["ord_buyprice"] * $ord_row["ord_amount"], $ord_row["ord_buyprice"]); ?><br />
                                                        <span
