...
<head>
    ...
    <title>Update Order Status | Lumbini-Cafeteria</title>
</head>
        ...
        <form method="POST" action="admin_order_update.php" class="form-floating">
            ...
            <div class="form-floating mb-2">
                <select class="form-select" id="orderstatus" name="os">
                    ...
                    <option value="VRFY" <?php if ($row["orh_orderstatus"] == "VRFY") {
                        echo "selected";
                    } ?>>VRFY | Order
                        Verifying</option>
                    <option value="ACPT" <?php if ($row["orh_orderstatus"] == "ACPT") {
                        echo "selected";
                    } ?>>ACPT | Order
                        Accepted</option>
                    <option value="PREP" <?php if ($row["orh_orderstatus"] == "PREP") {
                        echo "selected";
                    } ?>>PREP | Order
                        Preparing</option>
                    <option value="RDPK" <?php if ($row["orh_orderstatus"] == "RDPK") {
                        echo "selected";
                    } ?>>RDPK | Ready for
                        Pick-Up</option>
                    <option value="FNSH" <?php if ($row["orh_orderstatus"] == "FNSH") {
                        echo "selected";
                    } ?>>FNSH | Order
                        Finished</option>
                    <option value="CNCL" <?php if ($row["orh_orderstatus"] == "CNCL") {
                        echo "selected";
                    } ?>>CNCL | Order
                        Cancelled</option>
                </select>
