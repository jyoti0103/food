...
<head>
    ...
    <title>Successfully Order | Cafe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center reg-success mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold text-wrap">We'll notify the Cafeteria Staff in a few moments. <br/>You can check status in order history menu.</p>
